...
object DAOFactory {
  ...
  def categoryDAO: CategoryDAO = dbConfig match {
    case Some("mongo") => throw new UnsupportedOperationException("not implemented yet") //MongoCategoryDAO
    case Some("sql") => AnormCategoryDAO
    case None => AnormCategoryDAO
  }
